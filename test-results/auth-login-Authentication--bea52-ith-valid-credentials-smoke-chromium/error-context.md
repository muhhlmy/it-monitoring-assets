...
- Name: auth\login.spec.js >> Authentication - Login Suite >> SMOKE-01: Should login successfully with valid credentials @smoke
- Location: e2e\tests\auth\login.spec.js:9:3
