...
- Name: auth\login.spec.js >> Authentication - Login Suite >> Should toggle password visibility when clicking eye icon
- Location: e2e\tests\auth\login.spec.js:48:3
  ...
  - generic [ref=e27]:
    ...
    - generic [ref=e31]:
      - generic [ref=e32]:
        ...
        - generic [ref=e34]:
          - generic: mail
          - textbox "Email atau nama pengguna" [ref=e35]:
